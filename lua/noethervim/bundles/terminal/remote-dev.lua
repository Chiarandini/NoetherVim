...
---@requires exe=distant label="distant"
---          why="the local half of the connection"
---          install="https://distant.dev/"
---@requires note="distant on the remote host"
---          why="the remote half of the connection"
---          install="ssh host 'curl -L https://sh.distant.dev | sh'"
